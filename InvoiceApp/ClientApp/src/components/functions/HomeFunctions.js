export const progressSteps = [
    { description: "Add atleast one Service Provider and Client", width: "12.5%" },
    { description: "Add atleast one Product or Service", width: "25%" },
...
export const style = "square bg-dark rounded-top text-center text-white mb-0";
